...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | IndiAdmin - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page IndiAdmin Dashboard Template",
  // other metadata
};
